...
const handleReset = () => {
  ...
  shuffleSelection()
  // 刷新组件
  router.replace({ name: 'project4' }).then(() => {
    router.push({ name: 'project4' })
  })
}
...
.text-content {
  ...
  transform: rotate(180deg); /* 与容器旋转方向相反，抵消旋转效果 */
